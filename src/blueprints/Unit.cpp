...
Unit::Unit(sc2::UNIT_TYPEID who_builds_, sc2::UNIT_TYPEID required_addon_ /*= sc2::UNIT_TYPEID::INVALID*/)
    :m_who_builds(who_builds_)
    ,m_required_addon(required_addon_)
{
}

bool Unit::CanBeBuilt(const Order* order_)
{
